    ...
    return (
        <div>
            ...
            <main className="about-page min-h-screen flex flex-grow relative overflow-scroll">
                ...
                <div className='w-1/5 ml-10 mt-60 mb-20'>
                    <DraggableWindow title="Team" >
                        <p className="px-6">Team info here</p>
                    </DraggableWindow>
                </div>
                <div className='w-2/3 mt-48 ml-10 mb-20'>
                    <DraggableWindow title="Team" >
                        <div className="px-6 text-xl">
                            <p>  This doctoral project is dedicated to exposing the use of white phosphorus in South Lebanon as a tool of environmental manipulation. Through spatial analysis and geolocation, we document how this toxic substance transforms landscapes into long-term hazards, challenging official narratives.
                            </p> <br /><br />
                            <h2>The Clouds Atlas</h2>
                            <p>
                                This gallery presents a visual taxonomy of cloud and plume shapes resulting from different types of military attacks. By studying these atmospheric patterns, the research distinguishes between various weaponry, with a focus on identifying the unique characteristics of white phosphorus.<br />
                            </p>
