    ...
    return (
        <div>
            ...
            <main className="about-page min-h-screen flex fixed overflow-hidden">
                ...
                <div
                    className={`h-full w-1/5 ml-10 mt-16 mb-10 transform transition-all duration-1000 ease-in-out 
                    ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
                >
                    <ContentWindow title="Team">
                        <p className="mx-6 mt-6">Team info here</p>
                    </ContentWindow>
                </div>

                <div
                    className={`h-full w-4/5 mr-20 mt-16 ml-10 mb-10 transform transition-all duration-1000 ease-in-out 
