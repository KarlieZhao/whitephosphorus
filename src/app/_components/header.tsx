...
const Header = () => {
  ...
  const mainClicked = () => router.push('/');
  const cloudClicked = () => router.push('/');
  const aboutClicked = () => router.push('/');
        ...
        <div className="relative z-10">
          <table className={`${styles.table1}`}>
            <tbody> <tr className="text-center leading-none text-2xl tracking-tight flex items-center">
              <td className={`hover:bg-white hover:text-black transition cursor-pointer w-1/2 align-top" items-center ${styles.withBorder}`}
                colSpan={3}
                onClick={mainClicked}>
              ...
              <td className={`hover:bg-white hover:text-black transition cursor-pointer w-1/4 align-top" ${styles.withBorder}`}
                colSpan={3}
