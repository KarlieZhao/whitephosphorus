...
import SatelliteViewer from "./satellite-map";
...
export default function DataSource({ TypeWriterFinished = true }: TypewriterProps) {
    ...
    return (<>
        ...
        <div className="fixed right-3 top-28 z-50 side-bar">
            <div className="mt-2"><Timeline geoData={geoData} selectedCity={selectedCity} /></div>
            ...
            <div className="mt-3"><Segment geoData={geoData} selectedCity={selectedCity} selectedDay={selectedDay}
                onSegmentClick={(day) => {
                    if (day === null) return;
            ...
            <div className="mt-7"><Area geoData={geoData} selectedCity={selectedCity} /></div>
        </div>
