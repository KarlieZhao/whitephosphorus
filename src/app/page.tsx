...
export default function Index() {
  ...
  const textToTypeMobile = ["This archive documents 287 white phosphorus strikes in South Lebanon between October 2023 and May 2026.", "Over 700 images and videos were collected and geolocated as evidence.", "Tap anywhere to start."];
