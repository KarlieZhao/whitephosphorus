...
export default function Index() {
  const textToType = ["This public archive documents 286 white phosphorus strikes in South Lebanon and one in northern Israel between October 2023 and May 2026.", "Through open source tools, more than 700 images and videos were collected and verified as evidence, the majority geolocated and chronolocated.", "Click anywhere to start."];
  const textToTypeMobile = ["This archive documents 286 white phosphorus strikes in South Lebanon between October 2023 and May 2026.", "Over 700 images and videos were collected and geolocated as evidence.", "Tap anywhere to start."];
