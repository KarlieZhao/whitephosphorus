 ...
 * categories down the y-axis, time across the x-axis sized to fit — so the page scrolls
 * down through towns rather than sideways through time.
 *
...
export default function TimelineRowsPrototype() {
  ...
  return (
    <div className="min-h-screen bg-black text-white" style={{ fontFamily: "Inconsolata, monospace" }}>
      ...
      {model && (
        <div className="px-6 pt-2 pb-16 border-t border-white/10">
